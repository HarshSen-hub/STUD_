...
app = Flask(__name__)
app.secret_key = "insightx-secret-key-change-me"   # ← REQUIRED for sessions
CORS(app)
...
# ── Register & Teacher Login (kept as is) ─────────────────────
...
# ── Manual predict, upload, etc. (kept as is) ─────────────────
...
def upload_file():
    # (Your existing upload code - keeping it unchanged)
    try:
